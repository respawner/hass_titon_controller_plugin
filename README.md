...
2. Search for **Titon Controller** and install it. Choose the latest release (e.g. v2.0.1). If releases are not listed, enable “Show Beta” and pick the newest tag (avoid selecting raw commit hashes to prevent HACS download errors).
